...
export default function About3() {
    return (
      <div className="bg-white pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32">
        <div className="bg-[#219C90] pb-20 sm:pb-24 xl:pb-0">
          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <blockquote className="text-xl/8 font-semibold text-white sm:text-2xl/9">
                  <p>
                   I can speak multiple languages. I'll make sure that our customers feel welcome and heard. I can also mimic restaurant background noises!
                  </p>
                </blockquote>
            ...
            <div className="-mt-8 max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
